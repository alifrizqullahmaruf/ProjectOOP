...
public class MainFrame extends JFrame {
    ...
    public MainFrame() {
        ...
        panel3.setPreferredSize(new Dimension(1280, 832)); // Mengatur ukuran panel 3

        gameGUI = new GameGUI();
        gameGUI.setBounds(0, 0, 1280, 832); // Mengatur ukuran dan posisi GameGUI di dalam panel3
        panel3.add(gameGUI);
